  ...
  render() {
    ...
    return (
      <View style={styles.viewView}>
        <ScrollView contentContainerStyle={styles.viewScrollView}>
          <View
            pointerEvents="box-none"
            style={{
              alignSelf: 'stretch',
            ...
            <View style={styles.rectangle20View} />
            <TouchableOpacity
          ...
          <Dropdown
            ...
            onChangeText={value => {
              this.setState({missingIngredientsAmount: value});
            }}
          />
          <View>{element}</View>
        </ScrollView>
